...
var put = document.querySelectorAll('#form_1 input');
var allP = document.querySelectorAll('#form_1 .warn');
...
canvas_1.onclick=function(){
	ctx_1.clearRect(0,0,120,30);
	draw_1();
}
var clicks = document.getElementById('clik');
...
function draw_1(){
	ctx_1.fillStyle=randColor(170,250);
	ctx_1.fillRect(0,0,120,30);
	var letter = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';
	for(var i=0;i<=90;i+=30){
        var c = letter[randNum(0,letter.length)];
        ctx_1.fillStyle=randColor(60,160);
        ctx_1.font=randNum(15,40)+'px SimHei';
        ctx_1.fillText(c,i+randNum(0,15),randNum(15,30));
	}
	for(var i=0;i<10;i++){
		ctx_1.beginPath();
		ctx_1.moveTo(randNum(0,120),randNum(0,30)); 
		ctx_1.lineTo(randNum(0,120),randNum(0,30)); 
		ctx_1.strokeStyle=randColor(60,160);
		ctx_1.stroke();
	}
	for(var i=0;i<10;i++){
		ctx_1.beginPath();
		ctx_1.moveTo(randNum(0,120),randNum(0,30),randNum(1,5),0,2*Math.PI); 
		ctx_1.strokeStyle=randColor(60,160);
		ctx_1.stroke();
	}
}
...
province.onchange = function(){
	var zhi = this.value;
	for(var i=0;i<provinceList.length;i++){
		if(zhi==provinceList[i].name){
		    arr1 = provinceList[i].cityList;
			city.innerHTML="<option value=-请选择->-请选择-</option>";
			town.innerHTML="<option value=-请选择->-请选择-</option>";
			for(var j=0;j<arr1.length;j++){
				city.innerHTML+="<option value="+ arr1[j].name+">"+arr1[j].name+"</option>";
			}
		}
	}
}
