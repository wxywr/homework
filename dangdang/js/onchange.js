...
for(var i=0;i<provinceList.length;i++){
	...
	// console.log("<option value="+ provinceList[i].name+">"+provinceList[i].name+"</option>");
}
province.onchange = function(){
	var zhi = this.value;//把选择的省保存在变量zhi里面
	// console.log(zhi);
...
city.onchange = function(){//当城市下拉框的内容改变时
	var zhi = this.value;//把选择的市保存在局部变量zhi里
